...
const Income = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Record Income | RootFin</title>
      </Helmet>

      <div className="min-h-screen bg-[#f8f9fa]">
        <Headers title={"Income"} />
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200/80 p-6 md:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Optional Quantity for shoe sales */}
                  {selectedCategory.value === "shoe sales" && (
                    <div className="flex flex-col gap-1.5 md:col-span-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 shadow-sm transition-all"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                  ...
                  >
                    ...
                    <span>{isSubmitting ? "Submitting..." : "Submit Income"}</span>
                  </button>
                </div>
              </form>
            </div>
